...
import { useGetDealerVehicleVariants } from "@/mutations/dealer-inventory.mutation";
import { Check, ChevronsUpDown } from "lucide-react";
import { useState } from "react";

export default function DealerVehicleVariantMapSelect({
  onChange,
  className = "",
  value,
  disabled,
  ...
  const { data, isLoading, isError, error } =
    useGetDealerVehicleVariants(vehicleId);
